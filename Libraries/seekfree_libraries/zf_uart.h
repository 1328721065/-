...
#define	UART1_SET_RX_FLAG (SCON  |= 0x01)
#define	UART2_SET_RX_FLAG (S2CON |= 0x01)
#define	UART3_SET_RX_FLAG (S3CON |= 0x01)
#define	UART4_SET_RX_FLAG (S4CON |= 0x01)

#define	UART1_SET_TX_FLAG (SCON  |= 0x02)
#define	UART2_SET_TX_FLAG (S2CON |= 0x02)
#define	UART3_SET_TX_FLAG (S3CON |= 0x02)
#define	UART4_SET_TX_FLAG (S4CON |= 0x02)

#define UART1_ENABLE_INTERRUPT   (ES = 1)
#define UART2_ENABLE_INTERRUPT   (IE2 |= 0x01)
#define UART3_ENABLE_INTERRUPT   (IE2 |= 0x08)
#define UART4_ENABLE_INTERRUPT   (IE2 |= 0x10)

#define UART1_DISABLE_INTERRUPT   (ES = 0)
#define UART2_DISABLE_INTERRUPT   (IE2 &= ~0x01)
#define UART3_DISABLE_INTERRUPT   (IE2 &= ~0x08)
#define UART4_DISABLE_INTERRUPT   (IE2 &= ~0x10)
